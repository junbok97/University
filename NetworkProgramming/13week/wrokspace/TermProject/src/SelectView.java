...
public class SelectView extends JFrame {
	...
	public SelectView(Vector<User> UserVec, MainView view, Vector<ChatView> ChatViewVec) {	
		...
		JButton btnMakeChatView = new JButton("\uCC44\uD305\uBC29 \uB9CC\uB4E4\uAE30");
		getContentPane().add(btnMakeChatView, BorderLayout.SOUTH);
		btnMakeChatView.addActionListener(new MakeChatAction());
	...
	public void update(Vector<User> UserVec) {
		/*
